...
RSpec.describe 'Test homepage' do
  ...
  scenario 'Navigation menu in unloggined user' do
    ...
    expect(page).not_to have_link 'Accounts',   href: '/app/accounts'
    expect(page).not_to have_link 'Records',    href: '/app/records'
    expect(page).not_to have_link 'Categories', href: '/app/categories'
